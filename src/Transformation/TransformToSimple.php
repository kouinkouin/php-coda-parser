...
class TransformToSimple implements TransformationInterface
{
    ...
    public function transform(Data\Raw\Statement $coda_statements)
    {
        ...
        $account_transactions->account = $this->transformToAccount(
            $coda_statements->identification,
            $coda_statements->original_situation
        );
    ...
    public function transformToAccount(
        Data\Raw\Identification $coda_identification = null,
        Data\Raw\OriginalSituation $coda_original_situation = null
    ) {
    ...
    public function transformToOtherPartyAccount(
        Data\Raw\Transaction22 $coda_line22 = null,
    ...
    public function transformTransaction(Data\Raw\Transaction $coda_transaction)
    {
        ...
        $transaction->account = $this->transformToOtherPartyAccount(
            $coda_transaction->line22,
            $coda_transaction->line23
        );
