...
class TransformToSimpleWithSepaDirectDebit extends TransformToSimple
{
    ...
    {
        $this->setSimpleObjectsDefinition(
            [
    ...
    public function transformTransactionWithSdd(
        Data\Raw\Transaction $coda_transaction,
        Data\Simple\TransactionSepaDirectDebit $transaction
    ) {
